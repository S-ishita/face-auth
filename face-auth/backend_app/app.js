...
app.post('/api/auth/login', cors(corsOptions), async (req, res) => {
    ...
    try {
        ...
        // }
        const bestMatchEmail = bestMatchUser.email
        console.log(bestMatchEmail);
        const userByEmail = await User.findOne({ bestMatchEmail })
       // console.log(userByEmail);
    //    console.log((await bcrypt.compare(password,userByEmail.password)))
